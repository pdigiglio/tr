...
//	: detail::value_sequence_impl<detail::from_any,
//std::make_index_sequence<sizeof...(Vals)>, Vals...>
//{
//	///// @brief Implicit cast to homogeneous tuple (if all of `Vals...` can
//be
